...
public class MinioUtils {
    ...
    static {
       try{
           minioClient =  MinioClient.builder()
                   ...
                   .credentials("cat-protection-system-admin", "12345678")
                   .build();
       } catch (Exception e){
           e.printStackTrace();
       }
    ...
    public static ObjectWriteResponse upload(String bucketName, String objectName, long objectSize,  InputStream inputStream) throws Exception{
    ...
    public static void download(String bucketName, String objectName, String filePath, boolean overwrite) throws Exception{
    ...
    public static String getPresignedUrl(String bucketName, String objectName, int duration, TimeUnit timeUnit) throws Exception{
